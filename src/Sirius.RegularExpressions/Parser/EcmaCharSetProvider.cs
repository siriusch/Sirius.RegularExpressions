...
namespace Sirius.RegularExpressions.Parser {
	public class EcmaCharSetProvider: CharSetProviderBase {
		...
		private static readonly Lazy<RangeSet<Codepoint>> dotCharSet = new Lazy<RangeSet<Codepoint>>(() => Codepoints.Valid - new RangeSet<Codepoint>("\n".ToCodepoints()), LazyThreadSafetyMode.PublicationOnly);
		...
		public EcmaCharSetProvider(IReadOnlyDictionary<string, RangeSet<Codepoint>> namedCharsets) : this(namedCharsets.CreateGetter()) { }

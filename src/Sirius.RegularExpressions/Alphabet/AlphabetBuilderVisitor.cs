...
namespace Sirius.RegularExpressions.Alphabet {
	internal class AlphabetBuilderVisitor<TLetter>: IRegexVisitor<TLetter, Func<RangeSet<TLetter>, object, RangeSet<TLetter>>, object>
		...
		public object Accept(RxAccept<TLetter> node, Func<RangeSet<TLetter>, object, RangeSet<TLetter>> context) {
		...
		public object Empty(RxEmpty<TLetter> node, Func<RangeSet<TLetter>, object, RangeSet<TLetter>> context) {
			return null;
		}
